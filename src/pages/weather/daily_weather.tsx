  ...
  render() {
    ...
    const dailyWeatherDoms = ds.map((d: DailyWeatherModel, index: number) => {
      ...
      const dayWeatherIcon =
        "https://mat1.gtimg.com/pingjs/ext2020/weather/pc/icon/weather/day/" +
        d.day_weather_code +
        ".png";
      const nightWeatherIcon =
        "https://mat1.gtimg.com/pingjs/ext2020/weather/pc/icon/weather/day/" +
      ...
      return (
        <View className="w-col at-col at-col-2 " style={style}>
          ...
          <View style={{ height: "15px", marginBottom: "10px" }}>
            {dateTxt}
          </View>
          <View style={{ height: "15px", marginBottom: "20px" }}>
            {d.day_weather}
          </View>
          ...
          <View
            style={{ height: "15px", marginBottom: "10px", color: "orange" }}
          >
            {d.max_degree}
          </View>
          <View
            style={{ height: "15px", marginBottom: "10px", color: "silver" }}
          >
            ↓
          </View>
          <View
            style={{ height: "15px", marginBottom: "20px", color: "#4fc3f7" }}
          >
            {d.min_degree}
          </View>
          <View style={{ marginBottom: "10px" }}>
            <Image
              src={nightWeatherIcon}
              style={{ width: "30px", height: "30px" }}
            ></Image>
          </View>
